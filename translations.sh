...
lang_ru=(
    ...
    # Menu.sh
    ["MENU_CLEANUP_PANEL"]="🗑️ Удалить панель Remnawave"
    ...
    ["RETURNING"]="⬅️ Возврат в главное меню..."
    ["MENU_CLEANUP_NODE"]="🗑️ Удалить Remnanode"
    ...
    ["VPN_METHOD_SELECT_HEADER"]="👻 Выбор метода маскировки трафика"
    ["VPN_METHOD_REALITY"]="Reality (маскировка под чужой сайт, проще)"
    ["VPN_METHOD_SELFSTEAL"]="Self-steal (маскировка под свой сайт, нужен домен)"
    ["VPN_METHOD_PROMPT"]="Выберите метод (используйте стрелки, Enter для выбора):"
    ["REALITY_MODE_SELECTED"]="Выбран режим 'Reality'. Установка Caddy будет пропущена."
    ["SELFSTEAL_MODE_SELECTED"]="Выбран режим 'Self-steal'. Начинается установка Caddy..."
    ["CADDY_STOPPING_FOR_REALITY"]="Обнаружен работающий контейнер Caddy. Останавливаем его, чтобы освободить порты для режима 'Reality'..."
    ["CADDY_STOPPED_SUCCESS"]="✅ Контейнер Caddy успешно остановлен."
    ["CADDY_STOP_FAILED"]="❌ Не удалось остановить контейнер Caddy."
    ["NETWORK_CREATION_START"]="🌐 Создание Docker-сети 'remnanode-network'..."
    ["NETWORK_ALREADY_EXISTS"]="✅ Сеть 'remnanode-network' уже существует."
    ["NETWORK_CREATED_SUCCESS"]="✅ Сеть 'remnanode-network' успешно создана."
    ["NETWORK_CREATE_FAILED"]="❌ Не удалось создать Docker-сеть."
    ...
    ["CLEANUP_PANEL_REMOVING_NETWORK"]="🌐 Удаление Docker-сети..."
    ["CLEANUP_PANEL_SUCCESS"]="✅ Все компоненты панели Remnawave успешно удалены."
    ["CLEANUP_PANEL_HEADER"]="🗑️ Удаление панели Remnawave"
    ["CLEANUP_PANEL_WARNING"]="ВНИМАНИЕ: Это действие безвозвратно удалит все контейнеры (remnawave, remnawave-db, remnawave-redis, caddy), базу данных и файлы панели из папки /opt/remnawave. Все данные будут стерты.\n\nВы уверены, что хотите продолжить?"
    ["CLEANUP_PANEL_COMPONENTS"]="⚙️ Остановка контейнеров и удаление базы данных (volumes)..."
    ["CLEANUP_PANEL_COMPONENTS_SUCCESS"]="✅ Контейнеры, сеть и тома Remnawave успешно удалены."
    ["CLEANUP_PANEL_DIR"]="🗑️ Удаление директории /opt/remnawave..."
    ["CLEANUP_PANEL_DIR_SUCCESS"]="✅ Директория панели успешно удалена."
    ["CLEANUP_PANEL_NOT_FOUND"]="ℹ️ Директория /opt/remnawave не найдена. Пропускаем удаление."
